...
public class HandCursorMovement : MonoBehaviour {
    ...
    private bool isHandCursorRendered;
    ...
    private void Update()
    {
        ...
        {
            if (this.isHandCursorRendered == true)
            {
                rndr.enabled = false;
                rndrPS.enabled = false;
                this.isHandCursorRendered = false;
            }
            return;
        }
        ...
        foreach (var body in bodies)
        {
            ...
            this.isHandCursorRendered = true;
            if (body.IsTracked)
            {
